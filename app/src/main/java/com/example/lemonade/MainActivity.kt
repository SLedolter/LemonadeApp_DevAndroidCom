...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        when (lemonadeState) {
            SELECT -> doSomeLemonPicking();
            SQUEEZE -> doSomeSqueezing();
            DRINK -> doSomeDrinking();
    ...
    private fun doSomeLemonPicking() {
        lemonSize = lemonTree.pick();
        squeezeCount = 0;
        lemonadeState = SQUEEZE;
    }

    private fun doSomeSqueezing() {
        squeezeCount++;
        lemonSize--;
